Cypress.Commands.add('testSetup', ({ theme = 'cds-default' } = {}) => {
  ...
  cy.exec('wp-env run tests-cli wp db import "test_run_dump.sql"', options).then((result) => {
    ...
    cy.exec('wp-env run tests-cli wp set_encrypted_option NOTIFY_API_KEY gc-articles-fb26a6b5-57aa-4cc2-85fe-3053ed344fe8-30569ea9-362b-41c4-a811-842ccf3db3dc', options)
