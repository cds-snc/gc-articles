        ...
        <div id="gc-form-wrapper" className="gc-form-wrapper">
            <form onSubmit={handleSubmit(handler)}>
                ...
                <div className="focus-group">
                    ...
                    {errors.subscribe_email_template_id && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.unsubscribe_email_template_id && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.subscribe_phone_template_id && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.unsubscribe_phone_template_id && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.subscribe_redirect_url && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.unsubscribe_redirect_url && <p className="gc-error-message" role="alert">error here</p>}
                ...
                <div className="focus-group">
                    ...
                    {errors.confirm_redirect_url && <p className="gc-error-message" role="alert">error here</p>}
