...
class FormHelpers
{
    ...
    public static function render($list_options)
    {
      ...
      <div class="wrap">
            ...
            <tr>
              ...
              <td>
                <select name="list_id" id="list_id">
                    <?php try {
                        self::render_options($list_options);
                    } catch (Exception $e) {
                        echo '<option value="">' .
        ...
        <div id="notify-panel"></div><script>CDS.Notify.renderPanel({ "sendTemplateLink" : false});</script>
      </div>
        <?php
    }
