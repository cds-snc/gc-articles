                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <p style={{ marginBottom: '10px' }}>{__("Use the", "cds-snc")} <a href="https://notification.canada.ca/formatting-guide" target="_blank">{__("email formatting guide", "cds-snc")}</a> {__("(Opens in a new tab) to craft your message.", "cds-snc")}</p>
